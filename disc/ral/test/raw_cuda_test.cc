...
//   ral/test/test.mlir
// step 3:
//   bazel build //ral:raw_cuda_test
// step 4:
//   bazel build //ral:libral_base_context.so
// step 5: h/d for host/device
//   bazel-bin/ral/raw_cuda_test
//   bazel-bin/ral/libral_base_context.so ./out.so
...
// bazel-bin/ral/raw_cuda_test
//   r bazel-bin/ral/libral_base_context.so
//   ./out.so
