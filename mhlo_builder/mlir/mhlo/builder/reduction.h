...
mlir::Value
BuildReduction(mlir::OpBuilder &builder, const mlir::Location &loc,
               const mlir::Value &init_value, const mlir::Value &input,
               const SmallVec4<mlir_dim_t> &reduce_dims, bool keepdim = false) {
