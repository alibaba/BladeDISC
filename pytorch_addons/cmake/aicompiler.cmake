if (DEFINED ENV{USE_AICOMPILER_PRE_BUILD})
  # This flag was introduced to speedup torch_addons building for developers.
...
if (DEFINED TORCH_ADDONS_CUDA_VERSION)
   set(ENV{TAO_DOCKER_CUDA_VERSION} ${TORCH_ADDONS_CUDA_VERSION})
endif()
...
if (NOT TORCH_ADDONS_BUILD_WITH_CUDA_SUPPORT)
    list(APPEND AICOMPILER_CONFIG --cpu_only)
endif (NOT TORCH_ADDONS_BUILD_WITH_CUDA_SUPPORT)

if (TORCH_ADDONS_USE_ROCM)
    list(APPEND AICOMPILER_CONFIG --dcu)
endif (TORCH_ADDONS_USE_ROCM)

if (DEFINED TORCH_ADDONS_USE_CXX11_ABI AND TORCH_ADDONS_USE_CXX11_ABI)
