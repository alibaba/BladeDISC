...
#ifdef TORCH_ADDONS_BUILD_WITH_CUDA
#ifdef TORCH_ADDONS_USE_ROCM
#include <c10/hip/HIPCachingAllocator.h>
#include <c10/hip/HIPFunctions.h>
#else // TORCH_ADDONS_USE_ROCM
#include <c10/cuda/CUDACachingAllocator.h>
#include <c10/cuda/CUDAFunctions.h>
#endif // TORCH_ADDONS_USE_ROCM
#endif // TORCH_ADDONS_BUILD_WITH_CUDA
...
torch::List<torch::Tensor> RalContext::CreateAndBindingOutputs(
  ...
  for (size_t idx = 0; idx < num_outputs; ++idx) {
    ...
    torch::DeviceType dev_type =
        torch::kCUDA; // default compatiable with torch_addons version < 0.0.3
