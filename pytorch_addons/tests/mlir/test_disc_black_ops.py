...
class TestDiscBlackOps(DiscTestCase):
  ...
  %30 : __torch__.torch.classes.torch_addons.InitEngine = prim::GetAttr[name="BladeInit"](%self)
  %31 : None = prim::CallMethod[name="forward"](%30)
  %33 : __torch__.torch.classes.torch_addons.TaoEngine = prim::GetAttr[name="mlir_grp0_len8_0"](%self)
  ...
  %34 : __torch__.torch.classes.torch_addons.TaoEngine = prim::GetAttr[name="mlir_grp0_len1_0"](%self)
  ...
  %39 : __torch__.torch.classes.torch_addons.TaoEngine = prim::GetAttr[name="mlir_grp1_len2_1"](%self)
