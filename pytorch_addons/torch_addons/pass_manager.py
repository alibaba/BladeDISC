...
from torch_addons.config import Config, OptPipelines
...
def _jit_pass_lower_to_onnx(graph):
    ...
    onnx_graph, value_map = torch_addons.tools._jit_pass_onnx(
    ...
    torch_addons.jit_pass_onnx_constant_f64_to_f32(onnx_graph)
