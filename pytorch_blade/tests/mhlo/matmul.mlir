...
// CHECK:         %[[T0:.*]] = mhlo.constant dense<1.000000e+00> : tensor<256x256xf32>
// CHECK:         %[[T1:.*]] = "mhlo.dot"(%[[ARG0]], %[[T0]]) : (tensor<?x256xf32>, tensor<256x256xf32>) -> tensor<2x256xf32>
// CHECK:         return %[[T1]] : tensor<2x256xf32>
...
// CHECK:         %[[T0:.*]] = "mhlo.dot"(%[[ARG0]], %[[ARG1]]) : (tensor<?xf32>, tensor<256x?xf32>) -> tensor<1xf32>
