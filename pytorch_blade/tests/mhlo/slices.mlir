...
func @torch.aten.select.int(%arg0: !torch.vtensor<[4,65,256],f32>) -> !torch.vtensor<[4,256],f32> {
...
func @torch.aten.slice.stride2(%arg0: !torch.vtensor<[4,65,256],f32>) -> !torch.vtensor<[2,65,256],f32> {
...
func @torch.aten.slice.dim1(%arg0: !torch.vtensor<[4,65,256],f32>) -> !torch.vtensor<[4,1,256],f32> {
  %int0 = torch.constant.int 0
  %int1 = torch.constant.int 1
...
func @torch.aten.slice.none(%arg0: !torch.vtensor<[4,65,256],f32>) -> !torch.vtensor<[4,33,256],f32> {
  %int1 = torch.constant.int 1
  %int2 = torch.constant.int 2
