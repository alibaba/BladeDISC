...
func.func @decompose_split(%arg0: !torch.vtensor<[?,?,?],f16>) -> (!torch.vtensor<[?,?,?],f16>, !torch.vtensor<[?,?,?],f16>) {
  ...
  %10 = torch.aten.split.Tensor %arg0, %int1280, %int-1 : !torch.vtensor<[?,?,?],f16>, !torch.int, !torch.int -> !torch.list<vtensor>
...
// CHECK: torch.aten.slice.Tensor %arg0, %int-1, %int0_1, %0, %int1_0 : !torch.vtensor<[?,?,2000],f16>, !torch.int, !torch.int, !torch.int, !torch.int -> !torch.vtensor<[?,?,1280],f16>
  %10 = torch.aten.split.Tensor %arg0, %int1280, %int-1 : !torch.vtensor<[?,?,2000],f16>, !torch.int, !torch.int -> !torch.list<vtensor>
