...
// CHECK:   return %cst
func @torch.aten.tensor.int() -> !torch.tensor<[], si64> {
...
// CHECK:   return %0
func @torch.aten.literal.sint() -> !torch.tensor<[4], si64> {
...
// CHECK:   return %0
func @torch.aten.literal.ui8() -> !torch.tensor<[4],ui8> {
...
// CHECK:   return %0
func @torch.aten.literal.ui1() -> !torch.tensor<[4], i1> {
...
// CHECK:   return %0
func @torch.aten.literal.f32() -> !torch.tensor<[4], f32> {
