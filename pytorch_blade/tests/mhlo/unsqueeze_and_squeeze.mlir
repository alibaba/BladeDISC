...
// CHECK-LABEL:  func @torch.aten.squeeze.dim0(
// CHECK-SAME:         %[[ARG0:.*]]: tensor<2x1x2x1x2xf32>) -> tensor<2x1x2x1x2xf32> {
// CHECK:         return %[[ARG0]] : tensor<2x1x2x1x2xf32>
func @torch.aten.squeeze.dim0(%arg0: !torch.vtensor<[2,1,2,1,2],f32>) -> !torch.vtensor<[2,1,2,1,2],f32> {
...
// CHECK-LABEL:  func @torch.aten.squeeze.dim1(
...
func @torch.aten.squeeze.dim1(%arg0: !torch.vtensor<[?,1,?,1,?],f32>) -> !torch.vtensor<[?,?,1,?],f32> {
  %int1 = torch.constant.int 1
  %0 = torch.aten.squeeze.dim %arg0, %int1 : !torch.vtensor<[?,1,?,1,?],f32>, !torch.int -> !torch.vtensor<[?,?,1,?],f32>
  return %0 : !torch.vtensor<[?,?,1,?],f32>
}

// CHECK-LABEL:  func @torch.aten.squeeze.dim2.from_end(
...
func @torch.aten.squeeze.dim2.from_end(%arg0: !torch.vtensor<[?,1,?,1,?],f32>) -> !torch.vtensor<[?,1,?,?],f32> {
  %int-2 = torch.constant.int -2
  %0 = torch.aten.squeeze.dim %arg0, %int-2 : !torch.vtensor<[?,1,?,1,?],f32>, !torch.int -> !torch.vtensor<[?,1,?,?],f32>
  return %0 : !torch.vtensor<[?,1,?,?],f32>
}

// CHECK-LABEL:  func @torch.aten.squeeze(
...
func @torch.aten.squeeze(%arg0: !torch.vtensor<[2,1,2,1,2],f32>) -> !torch.vtensor<[2,2,2],f32> {
  %0 = torch.aten.squeeze %arg0 : !torch.vtensor<[2,1,2,1,2],f32> -> !torch.vtensor<[2,2,2],f32>
  return %0 : !torch.vtensor<[2,2,2],f32>
}

// CHECK-LABEL:  func @torch.aten.unsqueeze.dim0(
...
func @torch.aten.unsqueeze.dim0(%arg0: !torch.vtensor<[?,?,?,?],f32>) -> !torch.vtensor<[1,?,?,?,?],f32> {
  %int0 = torch.constant.int 0
  %0 = torch.aten.unsqueeze %arg0, %int0 : !torch.vtensor<[?,?,?,?],f32>, !torch.int -> !torch.vtensor<[1,?,?,?,?],f32>
  return %0 : !torch.vtensor<[1,?,?,?,?],f32>
}

// CHECK-LABEL:  func @torch.aten.unsqueeze.dim1(
...
func @torch.aten.unsqueeze.dim1(%arg0: !torch.vtensor<[?,?,?,?],f32>) -> !torch.vtensor<[?,1,?,?,?],f32> {
  %int1 = torch.constant.int 1
  %0 = torch.aten.unsqueeze %arg0, %int1 : !torch.vtensor<[?,?,?,?],f32>, !torch.int -> !torch.vtensor<[?,1,?,?,?],f32>
  return %0 : !torch.vtensor<[?,1,?,?,?],f32>
}

// CHECK-LABEL:  func @torch.aten.unsqueeze.dim2.from_end(
...
func @torch.aten.unsqueeze.dim2.from_end(%arg0: !torch.vtensor<[?,?,?,?],f32>) -> !torch.vtensor<[?,?,?,1,?],f32> {
  %int-2 = torch.constant.int -2
