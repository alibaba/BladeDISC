...
def config_mkldnn(root, args):
    ...
    if args.x86:
        with cwd(mkl_dir):
            ...
            download_cmd = """
              unset HTTPS_PROXY
              curl -fsSL https://pai-blade-hk.oss-cn-hongkong.aliyuncs.com/build_deps/mkl/mkl-static-2022.0.1-intel_117.tar.bz2  | tar xjv
              curl -fsSL https://pai-blade-hk.oss-cn-hongkong.aliyuncs.com/build_deps/mkl/mkl-include-2022.0.1-h8d4b97c_803.tar.bz2 | tar xjv
            """
