...
// Adopted from tensorflow/compiler/tf2xla/functionalize_while.h

#ifndef TAO_TAO_BRIDGE_PASSES_FUNCTIONALIZE_WHILE_H_
#define TAO_TAO_BRIDGE_PASSES_FUNCTIONALIZE_WHILE_H_
