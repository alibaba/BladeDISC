...
#ifndef TAO_TAO_BRIDGE_TF_UNION_FIND_H_
#define TAO_TAO_BRIDGE_TF_UNION_FIND_H_
...
template <typename T> void UnionFind<T>::Merge(UnionFind *other) {
...
template <typename T> UnionFind<T> *UnionFind<T>::FindRoot() {
  if (!parent_)
    return this;
...
#endif // TAO_TAO_BRIDGE_TF_UNION_FIND_H_
