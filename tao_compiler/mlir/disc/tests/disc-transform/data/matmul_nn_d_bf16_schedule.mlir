transform.structured.canonicalized_sequence failures(propagate) {
  ^bb0(%arg1: !pdl.operation):
    ...
    %1:4 = transform.structured.fuse %0#1 {tile_sizes = [2, 2, 4], tile_interchange = [0, 1, 2]}
    ...
    transform.disc.vector.vector_to_bfmmla_conversion %contract : (!pdl.operation) -> !pdl.operation 
