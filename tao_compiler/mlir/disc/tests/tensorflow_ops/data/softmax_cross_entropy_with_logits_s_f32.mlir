func @main(%features: tensor<13x21xf32>, %labels: tensor<13x21xf32>) -> (tensor<13xf32>, tensor<13x21xf32>) attributes {tf.entry_function = {inputs = "{{INPUTS}}", outputs = "{{OUTPUTS}}", input_placements="{{INPUT_PLACEMENTS}}", output_placements="{{OUTPUT_PLACEMENTS}}"}} {
