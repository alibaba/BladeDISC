...
TEST(TFGreaterOpTest, StaticShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_s_i64.mlir",
      /*backend_types*/
...
TEST(TFGreaterOpTest, FullyDynamicShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_d_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
      /*num_inputs*/ 2,
      /*num_outputs*/ 1,
...
TEST(TFGreaterOpTest, PartialShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_p_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
      /*num_inputs*/ 2,
      /*num_outputs*/ 1,
...
TEST(TFGreaterOpTest, ImplicitBroadcast2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_d_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
...
TEST(TFGreaterOpTest, ProvidedDataShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_d_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
