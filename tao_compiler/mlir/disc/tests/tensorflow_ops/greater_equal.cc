...
TEST(TFGreaterEqualOpTest, StaticShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_equal_s_i64.mlir",
      /*backend_types*/
...
TEST(TFGreaterEqualOpTest, FullyDynamicShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_equal_d_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
      /*num_inputs*/ 2,
      /*num_outputs*/ 1,
...
TEST(TFGreaterEqualOpTest, PartialShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_equal_p_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
      /*num_inputs*/ 2,
      /*num_outputs*/ 1,
...
TEST(TFGreaterEqualOpTest, ImplicitBroadcast2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_equal_d_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
...
TEST(TFGreaterEqualOpTest, ProvidedDataShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "greater_equal_d_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
