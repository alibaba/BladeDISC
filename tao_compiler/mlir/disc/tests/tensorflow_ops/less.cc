...
TEST(TFLessOpTest, StaticShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "less_s_i64.mlir",
      /*backend_types*/
...
TEST(TFLessOpTest, FullyDynamicShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "less_d_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
      /*num_inputs*/ 2,
      /*num_outputs*/ 1,
...
TEST(TFLessOpTest, PartialShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "less_p_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
      /*num_inputs*/ 2,
      /*num_outputs*/ 1,
...
TEST(TFLessOpTest, ImplicitBroadcast2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "less_d_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
...
TEST(TFLessOpTest, ProvidedDataShape2DI64) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "less_d_i64.mlir",
      /*backend_types*/
      kSupportedBackendList,
