...
TEST(TFSignOpTest, StaticShape2DF32) {
...
TEST(TFSignOpTest, FullyDynamicShape2DF32) {
  EXPECT_TRUE(feature_test_main(
...
TEST(TFSignOpTest, PartialDynamicShape2DF32) {
  EXPECT_TRUE(feature_test_main(
...
TEST(TFSignOpTest, ProvidedDataShape2DF32) {
  EXPECT_TRUE(feature_test_main(
      /*mlir_file_path*/ c_ft_path + "sign_d_f32.mlir",
      /*backend_types*/
      kSupportedBackendList,
