...
struct HloToLhloConcatenateOpConverter
    : public OpRewritePattern<lmhlo::ConcatenateOp> {
  explicit HloToLhloConcatenateOpConverter(MLIRContext* context)
...
struct DiscLhloRewriterPass
 ...
 public:
  ...
  void runOnOperation() override {
    ...
    patterns.insert<HloToLhloConcatenateOpConverter>(&context);
    if (failed(
