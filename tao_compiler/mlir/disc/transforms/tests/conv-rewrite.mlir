...
func.func @dynamic_conv(%arg0: tensor<?x32x32x6xf32>, %arg1: tensor<3x3x3x16xf32>) -> tensor<?x8x7x16xf32> {
...
// CHECK-LABEL: @conv
func.func @conv(%arg0: tensor<?x32x32x6xf32>, %arg1: tensor<3x3x3x16xf32>) -> tensor<?x8x7x16xf32> {
  // CHECK: mhlo.transpose
  // CHECK-SAME: permutation = dense<[0, 3, 1, 2]>
  // CHECK: mhlo.transpose
