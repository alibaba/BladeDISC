...
func.func @simple_test(%arg0: !disc_ral.context) {
  ...
  %0 = memref.alloc() : memref<100x100xf32, #gpu.address_space<global>>
  ...
  "lmhlo.constant"(%0) {disc.device = "gpu", value = dense<1.000000e+00> : tensor<100x100xf32>} : (memref<100x100xf32, #gpu.address_space<global>>) -> ()
  "lmhlo.constant"(%1) {disc.device = "cpu", value = dense<1.000000e+00> : tensor<100x100xf32>} : (memref<100x100xf32>) -> ()
  "disc_ral.send_output"(%arg0, %c0, %0) : (!disc_ral.context, index, memref<100x100xf32, #gpu.address_space<global>>) -> ()
  "disc_ral.send_output"(%arg0, %c1, %1) : (!disc_ral.context, index, memref<100x100xf32>) -> ()
  return
}
