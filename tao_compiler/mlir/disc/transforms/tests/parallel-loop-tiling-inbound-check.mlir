// RUN: disc-opt %s -pass-pipeline='builtin.func(disc-parallel-loop-tiling{parallel-loop-tile-sizes=1,4 with-inbound-check=true})' -split-input-file | FileCheck %s
