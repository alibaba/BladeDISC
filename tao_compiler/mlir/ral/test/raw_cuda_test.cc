...
//   mlir/raltest/test.mlir
// step 3:
//   bazel build //tensorflow/compiler/mlir/ral:raw_cuda_test
// step 4:
//   bazel build //tensorflow/compiler/mlir/ral:libral_base_context.so
// step 5: h/d for host/device
//   bazel-bin/mlir/ralraw_cuda_test
//   bazel-bin/mlir/rallibral_base_context.so ./out.so
...
// bazel-bin/mlir/ralraw_cuda_test
//   r bazel-bin/mlir/rallibral_base_context.so
//   ./out.so
