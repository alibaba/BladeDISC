...
RAL_REGISTER_CONST_CUDA_FUNC_0D(uint64_t);
...
RAL_REGISTER_CONST_CUDA_FUNC(uint64_t, 1);
RAL_REGISTER_CONST_CUDA_FUNC(uint64_t, 2);
RAL_REGISTER_CONST_CUDA_FUNC(uint64_t, 3);
RAL_REGISTER_CONST_CUDA_FUNC(uint64_t, 4);
RAL_REGISTER_CONST_CUDA_FUNC(uint64_t, 5);
RAL_REGISTER_CONST_CUDA_FUNC(uint64_t, 6);
RAL_REGISTER_CONST_CUDA_FUNC(uint64_t, 7);
RAL_REGISTER_CONST_CUDA_FUNC(uint64_t, 8);
