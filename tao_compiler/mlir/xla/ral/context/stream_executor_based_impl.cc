...
MemRefType<Eigen::half, 3> ral_pdll_mem_eff_attention_output_transpose_gpt(
    ExecutionContext* ctx, void* stream_handle /*stream_handle*/,
  ...
  TAO_VLOG(1) << "ral_pdll_mem_eff_attention_output_transpose_gpt";
...
TAO_RAL_API("ral_pdll_mem_eff_attention_output_transpose_gpt", "gpu",
            gpu::se_impl::ral_pdll_mem_eff_attention_output_transpose_gpt);
