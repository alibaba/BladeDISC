...
TorchAddonsDefNewFlag(nvinfer1::BuilderFlags, BuilderFlags);
TorchAddonsDefNewFlag(bool, TuneFlag);
...
BuilderFlagsGuard::~BuilderFlagsGuard() { SetBuilderFlags(prev_flags_); }
