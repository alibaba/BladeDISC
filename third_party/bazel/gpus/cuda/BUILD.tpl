...
cuda_header_library(
    name = "cublas_headers",
    hdrs = [":cublas-include"],
    include_prefix = "bzl/gpus/cuda/include",
...
cc_library(
    name = "cublas_static",
    srcs = ["cuda/lib/%{cublas_static_lib}"],
    data = ["cuda/lib/%{cublas_static_lib}"],
    linkstatic = 1,
)
...
cc_library(
    name = "cudnn_static",
    srcs = ["cuda/lib/%{cudnn_static_lib}"],
    data = ["cuda/lib/%{cudnn_static_lib}"],
    linkstatic = 1,
)

cc_library(
    name = "culibos_static",
    srcs = ["cuda/lib/%{culibos_static_lib}"],
    data = ["cuda/lib/%{culibos_static_lib}"],
    linkstatic = 1,
)
