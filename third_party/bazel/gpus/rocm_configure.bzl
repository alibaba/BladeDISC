...
def _tpl_path(repository_ctx, labelname):
    return repository_ctx.path(Label("//bazel/gpus/%s.tpl" % labelname))
...
def _create_local_rocm_repository(repository_ctx):
    ...
    find_rocm_config_script = repository_ctx.path(Label("//bazel/gpus:find_rocm_config.py.gz.base64"))
    ...
    # copy files mentioned in bzl/gpus/rocm/BUILD
    copy_rules.append(make_copy_files_rule(
        repository_ctx,
        name = "rocm-bin",
        srcs = [
