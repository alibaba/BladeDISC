...
std::shared_ptr<OperatorSet> nn_ops_first_input_preserving() {
  std::shared_ptr<OperatorSet> ops = std::make_shared<OperatorSet>(OperatorSet{
      ...
      "int[] padding, int[] dilation, int groups) -> Tensor",
      "aten::conv3d(Tensor input, Tensor weight, Tensor? bias, int[] stride, "
      "int[] padding, int[] dilation, int groups) -> Tensor",
      "aten::conv_tbc(Tensor self, Tensor weight, Tensor bias, int pad) -> "
      "Tensor",
      "aten::conv_transpose1d(Tensor input, Tensor weight, Tensor? bias, int[] "
      "stride, int[] padding, int[] output_padding, int groups, int[] "
      "dilation) -> Tensor",
      "aten::conv_transpose2d(Tensor input, Tensor weight, Tensor? bias, int[] "
      "stride, int[] padding, int[] output_padding, int groups, int[] "
      "dilation) -> Tensor",
      "aten::conv_transpose3d(Tensor input, Tensor weight, Tensor? bias, int[] "
      "stride, int[] padding, int[] output_padding, int groups, int[] "
      "dilation) -> Tensor",
      "aten::convolution(Tensor input, Tensor weight, Tensor? bias, int[] "
      ...
      "cudnn_enabled) -> Tensor",  // deprecated _convolution
      "aten::_convolution(Tensor input, Tensor weight, Tensor? bias, int[] "
      "stride, int[] padding, int[] dilation, bool transposed, int[] "
      "output_padding, int groups, bool benchmark, bool deterministic, bool "
      ...
      "aten::avg_pool1d(Tensor self, int[] kernel_size, int[] stride, int[] "
      "padding, bool ceil_mode, bool count_include_pad) -> Tensor",
      "aten::avg_pool2d(Tensor self, int[] kernel_size, int[] stride, int[] "
      "padding, bool ceil_mode, bool count_include_pad, int? divisor_override) "
      "-> Tensor",
      "aten::avg_pool3d(Tensor self, int[] kernel_size, int[] stride, int[] "
      "padding, bool ceil_mode, bool count_include_pad, int? divisor_override) "
      "-> Tensor",
      "aten::max_pool1d(Tensor self, int[] kernel_size, int[] stride, int[] "
      "padding, int[] dilation, bool ceil_mode) -> Tensor",
      "aten::max_pool2d(Tensor self, int[] kernel_size, int[] stride, int[] "
      "padding, int[] dilation, bool ceil_mode) -> Tensor",
      "aten::max_pool3d(Tensor self, int[] kernel_size, int[] stride, int[] "
      "padding, int[] dilation, bool ceil_mode) -> Tensor",
      "aten::max_unpool2d(Tensor self, Tensor indices, int[] output_size) -> "
      "Tensor",
      "aten::max_unpool3d(Tensor self, Tensor indices, int[] output_size, "
      ...
      "aten::upsample_linear1d(Tensor self, int[] output_size, bool "
      "align_corners, float? scales) -> Tensor",
      ...
      "aten::upsample_nearest3d(Tensor self, int[] output_size, float? "
      "scales_d, float? scales_h, float? scales_w) -> Tensor",
      "aten::upsample_trilinear3d(Tensor self, int[] output_size, bool "
      "align_corners, float? scales_d, float? scales_h, float? scales_w) -> "
      "Tensor",
