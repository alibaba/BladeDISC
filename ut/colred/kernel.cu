...
__global__ void kernel(
    ...
    int v14 = blockIdx.x * arg2; //arg2 256 threaddim
    int v15 = threadIdx.x;
    int total_threads = v14 + v15;
    if (total_threads < arg3) {
        int thread_x = total_threads % 256; //v16 % 256;
        int block_x = total_threads / 256;
        int v23 = thread_x / 8; // v32
        int v24 = thread_x % 8; // v32
        int v25 = block_x / arg4;
        int v26 = block_x % arg4;
        int v28 = v25 * 32 + v23; // limit 368
        int v30 = v26 * 8 + v24; // limit 32 -> 25
        bool v31 = v28 < arg1_2;
        bool v32 = v30 < arg0;
        if (v31 && v32) {
            int v53 = v28 * arg0 + v30;
            T v55 = arg5[v53]; // total arg6
            v28 = v28 * arg9 + arg7;
            v30 = v30 * arg10 + arg8;
            T v64 = arg13[v28 * arg11 + v30]; // total arg12 * arg11
            T v70 = arg13[v28 * arg11 + v30 + arg15];
            T v71 = v55 + v64 + v70;
