...
//#define MOD
#define KNAME "_Z6kernelmPdS_mmmmmmmmS_S_mmmmmmmmmmmmS_S_mmmmmmmS_S_mmmmmS_S_mmmmmS_S_mmmmmmmS_S_mmmmmS_S_mmm"
#define KNAME1 "main_kColReduction_dynamic_reshape_reduce__26_2_3___no_ibX8w32h_1_revised_revised_revised"
...
std::vector<void*> make_args(double ** ptr, double * input, double * output, double * output_reduce) {
  ...
  std::vector<uint64_t> tmp = {L0, L1 * L0, 4};
